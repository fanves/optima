$(document).ready(function() {
    ...
    function initSlickSlider (slider) {
        slider.each( function() {
          $(this).slick({
            prevArrow: '<button class="slick-prev slick-arrow"><img src="img/sl-left.svg" alt=""></button>',
            nextArrow: '<button class="slick-next slick-arrow"><img src="img/sl-right.svg" alt=""></button>',
            arrows: true,
            fade: true,
